...
buildNpmPackage {
  pname = "omp-undo-redo";
  version = "1.6.2-unstable-2026-09-08";

  src = fetchFromGitHub {
    owner = "Baylar55";
    repo = "omp-undo-redo";
    rev = "277108841f28fa65ca02fe6118312f6f564ef072";
    hash = "sha256-vk6q7VtC0s3OnXGrf7sGxJ6l2AraGdv4RcKeVabLTtU=";
  };

  nodejs = nodejs_24;
  npmDepsHash = "sha256-6JQ/DzVDyuRrQ42ZNeeMnBB4VvCFsxBYXmUldQlSpNY=";
