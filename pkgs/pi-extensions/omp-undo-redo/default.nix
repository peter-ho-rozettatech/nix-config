...
buildNpmPackage {
  ...
  src = fetchFromGitHub {
    owner = "Baylar55";
    repo = "omp-undo-redo";
    rev = "ab91934b75063a11dbeb354958f07c438711b68f";
    hash = "sha256-t/JLNEA5LuST4ZE6buxwLuAM6O/hiF/ixVtstLwl5U4=";
  };

  nodejs = nodejs_24;
  npmDepsHash = "sha256-RjT7sgC4VFNsleeolKjB3q+MyUDl4VFSKyLuCkGU2ww=";
