...
buildNpmPackage {
  pname = "omp-undo-redo";
  version = "1.6.1-unstable-2026-09-07";

  src = fetchFromGitHub {
    owner = "Baylar55";
    repo = "omp-undo-redo";
    rev = "02d315e119df8eebd7365a97aaff6981820bb80d";
    hash = "sha256-UM1gZCK26+czSUFA3WrOgYJ4eysgxCCczpJ8wYfrAfs=";
  };

  nodejs = nodejs_24;
  npmDepsHash = "sha256-HXlczFFpqLM9c6bO5ust6JZdBsi7fsMCmCWnLWCviYo=";
